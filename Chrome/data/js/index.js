...
function linkButton() {
  document.querySelector('.store').href = `https://chrome.google.com/webstore/detail/${chrome.runtime.id}`;
  document.querySelector('.r_store').href = `https://chrome.google.com/webstore/detail/${chrome.runtime.id}`;
  document.querySelector('.rate_store').href = `https://chrome.google.com/webstore/detail/${chrome.runtime.id}/reviews`;
  document.querySelector('.rate_store_1').href = `https://chrome.google.com/webstore/detail/${chrome.runtime.id}/reviews`;
