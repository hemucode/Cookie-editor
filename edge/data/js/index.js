...
function linkButton() {
  document.querySelector('.store').href = `https://microsoftedge.microsoft.com/addons/detail/${chrome.runtime.id}`;
  document.querySelector('.r_store').href = `https://microsoftedge.microsoft.com/addons/detail/${chrome.runtime.id}`;
  document.querySelector('.rate_store').href = `https://microsoftedge.microsoft.com/addons/detail/${chrome.runtime.id}`;
  document.querySelector('.rate_store_1').href = `https://microsoftedge.microsoft.com/addons/detail/${chrome.runtime.id}`;
